<template>
    <div>
            ...
            <div class="p-datatable">
              ...
              <div class="p-datatable-body">
                <div v-for="(user, index) in filteredUsers" :key="index" class="p-datatable-row">
                  ...
                  <div class="p-datatable-col">
                    <span
                      :class="{ 'text-success': user.status === 'Active', 'text-danger': user.status === 'Inactive' }">{{
                        user.status
                      }}</span>
                  </div>
                  <div class="p-datatable-col">
                    ...
                    <button class="p-button p-button-icon-only p-button-danger" @click="deleteUser(user)">
        ...
        <div class="p-grid">
          ...
          <div class="p-col-12">
            <div class="p-field">
              ...
              <RadioButton v-model="editedUser.status" name="status" value="Active" id="active" class="p-inputtext"/>
              <label for="active">Active</label>
              <RadioButton v-model="editedUser.status" name="status" value="Inactive" id="inactive"
                           class="p-inputtext"/>
      ...
      <!-- Add User Button -->
      <button v-if="!showUserForm" class="p-button p-button-primary p-mt-2" @click="addUser">Add User</button>
  </template>
